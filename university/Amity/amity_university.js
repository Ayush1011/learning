...
import emails from './amity_university_subjects year1';
...
import emailss from "./amity_university_subjects year2";
import {Collapse, CollapseBody, CollapseHeader} from "accordion-collapse-react-native";


export class Amity extends Component<{}> {
                    ...
                    <View style={{justifyContent: 'center',alignSelf:'center',alignItems: "center",marginTop:'50%'}}>
                        ...
                        <Collapse style={{padding:15,margin:15,}}>
                            <CollapseHeader style={{width:300,height:50,margin:15}}>
                                <View>
                                    <Text style={{justifyContent:'center',textAlign: 'center',borderWidth:2,borderColor:'grey',borderRadius:30,padding:15,fontSize: 15,fontFamily:'algerian',color: 'white'}}>First year all subjects</Text>
                                </View>
                            </CollapseHeader>
                        ...
                        <Collapse style={{padding:15,margin:15}}>
                            <CollapseHeader style={{width:300,height:50,margin:15}}>
                                <View>
                                    <Text style={{justifyContent:'center',textAlign: 'center',borderWidth:2,borderColor:'grey',borderRadius:30,padding:15,fontSize: 15,fontFamily:'algerian',color: 'white'}}>Second year all subjects</Text>
                                </View>
                            </CollapseHeader>
                            ...
                            <TouchableOpacity onPress={()=>this.props.navigation.navigate('second')}>
                                ...
                                <Animatable.Text animation="pulse" easing="ease-in-out" iterationCount="infinite" style={{alignSelf:'center',justifyContent:'center',textAlign: 'center',fontSize:15,margin:"5%",color:'white',alignItems: "center"}}>🔥2 year all subjects🔥</Animatable.Text>

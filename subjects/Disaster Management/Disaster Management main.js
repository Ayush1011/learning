...
import emails from './Disaster Management paper';
...
export class Disaster_Man extends Component<{}> {
                ...
                <View style={{justifyContent: 'center',alignSelf:'center',alignItems: "center",height:'100%',marginTop:'1%'}}>
                    ...
                    <Collapse style={{padding:15,margin:15,}}>
                        <CollapseHeader style={{width:300,height:50,margin:15}}>
                            <View>
                                <Text style={{justifyContent:'center',textAlign: 'center',borderWidth:2,borderColor:'grey',borderRadius:30,padding:15,fontSize: 15,fontFamily:'algerian',color: 'grey'}}>Disaster Management</Text>
                            </View>
                        </CollapseHeader>

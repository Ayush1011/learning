                ...
                <View style={{justifyContent: 'center',alignSelf:'center',alignItems: "center",height:'100%',marginTop:'1%'}}>
                    ...
                    <Collapse style={{padding:15,margin:15,}}>
                        <CollapseHeader style={{width:300,height:50,margin:15}}>
                            <View>
                                <Text style={{justifyContent:'center',textAlign: 'center',borderWidth:2,borderColor:'grey',borderRadius:30,padding:15,fontSize: 15,fontFamily:'algerian',color: 'grey'}}>Artificial Intelligence</Text>
                            </View>
                        </CollapseHeader>
                        <CollapseBody  style={{padding:15,margin:15,borderRadius:30,justifyContent:'center',alignItems:'center'}}>
                            <LinearGradient colors={['#9dd3e4', '#9dd3e4', '#716E77',]}
                                ...
                                >
                                    ...
                                    <Animatable.Text animation="pulse" easing="ease-in-out" iterationCount="infinite" style={{alignSelf:'center',justifyContent:'center',textAlign: 'center',fontSize:15,margin:"5%",color:'grey',alignItems: "center"}}>🔥AI🔥</Animatable.Text>
